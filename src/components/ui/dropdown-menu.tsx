...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className="absolute left-2 top-2.5 h-3.5 w-3.5 rounded-sm border border-input bg-background">
      {checked ? <span className="block h-full w-full bg-foreground" /> : null}
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
));
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    {...props}
  >
    <span className="absolute left-2 top-2.5 h-3.5 w-3.5 rounded-full border border-input" />
    {children}
  </DropdownMenuPrimitive.RadioItem>
));
